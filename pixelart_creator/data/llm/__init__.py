...
"""Model-agnostic LLM subpackage for the AI assistant (zero Qt, S11).
...
inside this package (REQ-P14-DATA-003/-006). The real stdlib-``urllib`` adapters — the
OpenAI-compatible core (:class:`~pixelart_creator.data.llm.openai_compatible.
