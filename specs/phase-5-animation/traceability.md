...
| REQ-P5-LOGIC-011 | Phase-5 cap (named animation), REQ-P5-LOGIC-002 | §4, §11 | SC-L011-1 | `test_animation.py` (`test_tag_playback_steps_uses_tag_mode_and_range`) | covered |
...
| REQ-P5-LOGIC-013 | **CO-4** (`blend.composite_stack`→per-frame render), S7 | §4, §11 | SC-L013-1 | `test_animation.py` (onion overlay via `composite_stack`) + `test_animation_canvas_frames.py` (`test_scene_cache_hit_roundtrip`) | covered |
...
| REQ-P5-UI-004 | REQ-P5-LOGIC-005 | §4, §11 | SC-UI-004-1 | `test_animation_timeline.py` (`test_ui_004_remove_frame_one_command_and_refuses_last`) | covered |
| REQ-P5-UI-005 | REQ-P5-LOGIC-006 | §4, §11 | SC-UI-005-1 | `test_animation_timeline.py` (`test_ui_005_reorder_frame_is_one_command`) | covered |
...
| REQ-P5-UI-007 | REQ-P5-LOGIC-008, FR-2 | §4, §11 | SC-UI-007-1 | `test_animation_timeline.py` (`test_ui_007_duration_editor_sets_duration_one_command`) | covered |
...
| REQ-P5-UI-009 | REQ-P5-LOGIC-001 | §4, §11 | SC-UI-009-1 | `test_animation_timeline.py` (`test_ui_009_*` — 4 modes, default LOOP, ONCE stop) | covered |
| REQ-P5-UI-010 | REQ-P5-LOGIC-003 | §4, §11 | SC-UI-010-1 | `test_animation_timeline.py` (`test_ui_010_playback_honours_per_frame_duration`) | covered |
...
| REQ-P5-UI-012 | REQ-P5-LOGIC-012, -014 | §4, §11 | SC-UI-012-1 | `test_animation_timeline.py` (`test_ui_012_onion_counts_and_tint_are_view_settings`) + `test_animation_timeline_wiring.py` (`test_onion_tint_pickers`) | covered |
...
| REQ-P5-UI-014 | REQ-P5-LOGIC-011 | §4, §11 | SC-UI-014-1 | `test_animation_timeline.py` (`test_ui_014_select_tag_plays_named_animation`) | covered |
...
| REQ-P5-UI-016 (NFR) | S1, S12, F2, F7, Art. VI, DEP-3 | §5, §11 | SC-UI-016-1 | `test_animation.py` (`test_onion_overlay_region_passthrough`) + `test_animation_canvas_frames.py` (`test_scene_cold_playback_advance_is_async`) + `test_animation_timeline_wiring.py` (`test_composite_warm_runnable_emits`, `test_frame_cache_api_branches`); AGT-10 `perf_profile --animation` (D1/D2/D3 landed; D4→FU-P5-PERF) | covered (perf profile pending) |
...
| REQ-P5-UI-019 (NFR) | Art. V §2, F6 | §5, §11 | SC-UI-019-1 | tr()-wrapped panels + `changeEvent` retranslate; AGT-07 `string_audit_check` | covered (string audit pending) |
