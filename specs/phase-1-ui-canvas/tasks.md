...
- **REQ / acceptance:** REQ-P1-UI-021 (SC-P1-UI-021-1), REQ-P1-UI-022 (SC-P1-UI-022-1).
- **Predecessor:** none.
...
- **REQ / acceptance:** REQ-P1-UI-009 (SC-P1-UI-009-1), REQ-P1-UI-010 (SC-P1-UI-010-1..3).
...
- **REQ / acceptance:** REQ-P1-UI-001 (SC-P1-UI-001-1/-2), -002 (SC-P1-UI-002-1/-2), -003 (SC-P1-UI-003-1/-2), -007 (grid draw, SC-P1-UI-007-1/-2).
- **Predecessor:** T1.
...
- **REQ / acceptance:** REQ-P1-UI-004 (SC-P1-UI-004-1/-2), -005 (SC-P1-UI-005-1/-2), -006 (SC-P1-UI-006-1..3), -007 (SC-P1-UI-007-2/-3), -008 (SC-P1-UI-008-1/-2).
...
- **REQ / acceptance:** REQ-P1-UI-011 (SC-P1-UI-011-1), -012 (SC-P1-UI-012-1), -013 (SC-P1-UI-013-1), -014 (SC-P1-UI-014-1/-2), -015 (SC-P1-UI-015-1), -016 (SC-P1-UI-016-1).
- **Predecessor:** T3, T5.
...
- **REQ / acceptance:** REQ-P1-UI-025 (SC-P1-UI-025-1).
- **Predecessor:** T2.
...
- **Do:** `Main_Window(QMainWindow)` — exclusive tool toolbar (017); `Palette_Panel(QWidget)` single-select in index order, sets active colour (018/CL-6); document tabs, per-doc `QUndoStack`, tab-switch swaps active context (020/SC-P1-UI-020-3); Undo/Redo actions bound to active stack, enable-state from `canUndo/canRedo` (019); menu bar File(New/Open/Save/Save As/Close)/Edit(Undo/Redo)/View(zoom, grid) (019); New at `DEFAULT_CANVAS_*`, 8K supported, Open/Save via `data/project_io` (020); accessible names on every control (024); apply theme (025); `changeEvent` retranslate (022).
- **REQ / acceptance:** REQ-P1-UI-017 (SC-P1-UI-017-1), -018 (SC-P1-UI-018-1/-2), -019 (SC-P1-UI-019-1), -020 (SC-P1-UI-020-1..3); + -022, -024, -025 cross-cutting.
...
- **Files:** `tests/ui/**` (one `test_*` per SC-P1-UI-* scenario; `conftest.py`)
- **Do:** one pytest-qt test per acceptance criterion (SC-P1-UI-001..022), headless offscreen, each run under **both** light and dark themes; a11y audit (accessible names, keyboard reachability, visible focus). Coverage gate ≥90/80.
- **REQ / acceptance:** REQ-P1-UI-024 (SC-P1-UI-024-1/-2), -025 (SC-P1-UI-025-1 + every scenario both themes); coverage for 001..022.
- **Predecessor:** T1–T8.
...
- **REQ / acceptance:** REQ-P1-UI-026 (SC-P1-UI-026-1).
- **Predecessor:** T8.
...
- **REQ / acceptance:** REQ-P1-UI-023 (SC-P1-UI-023-1/-2).
- **Predecessor:** T4, T5.
