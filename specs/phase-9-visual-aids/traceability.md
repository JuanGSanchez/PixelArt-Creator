...
| REQ-P9-LOGIC-008 **[GEO]** | Article I, S11, Phase-9 cap | §4, §11 | SC-L008-1 | `tests/logic/test_grids.py`/`test_guides.py`/`test_preview.py`/`test_timelapse.py` + `check_layering`/`check_cycles` exit 0 (Qt-free; no event loop) | spec'd (forward) |
| REQ-P9-LOGIC-009 **[GEO]** | P2 (determinism), S6, S11 | §4, §11 | SC-L009-1 | `tests/logic/test_grids.py` + Hypothesis (deterministic; no time/random/locale; tie-break) | spec'd (forward) |
...
| REQ-P9-LOGIC-011 | Article II, Article VII, S12 | §4, §11 | SC-L011-1 | `tests/logic/test_grids.py`/`test_guides.py`/`test_timelapse.py` (bounds from constants enforced) | spec'd (forward) |
...
| REQ-P9-UI-002 | REQ-P9-LOGIC-012, S7 | §4, §11 | SC-UI-002-1 | `tests/ui/test_preview_window.py` (mirrors edits live; read-only) | spec'd (forward) |
...
| REQ-P9-UI-008 | REQ-P9-LOGIC-012, S7 | §4, §11 | SC-UI-008-1 | `tests/ui/test_multi_view.py` (edit syncs across all views + preview, no manual refresh; local zoom/pan independent) | spec'd (forward) |
