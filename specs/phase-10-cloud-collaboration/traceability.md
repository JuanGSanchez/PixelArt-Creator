...
| --- | --- | --- | --- | --- | --- |
| REQ-P10-DATA-001 | S7 (optional cloud-sync layer), S11, Article I, Phase-10 cap | §2, §4, §11 | SC-D001-1 | `tests/data/cloud/test_cloud_port.py` (one port abstracts providers; verb set; no provider name) | spec'd (forward) |
...
| REQ-P10-DATA-005 | S13, Article IV, S11, Phase-10 cap (adapters swappable) | §2, §4, §11 | SC-D005-1 | `tests/data/cloud/test_fake_adapter.py` (whole contract verified with no network/credentials, headless) | spec'd (forward) |
...
| REQ-P10-LOGIC-004 (NFR) | Article VI, S1, S12 | §4, §5, §11 | SC-L004-1 | `tests/logic/test_sync_offloop.py` + AGT-10 posture (batch; not FRAME_BUDGET_MS-gated; UI responsive) | spec'd (forward) |
| REQ-P10-LOGIC-005 | Article II, Article VII, S12 | §4, §11 | SC-L005-1 | `tests/logic/test_cloud_bounds.py` (bounds from constants enforced; no literals) | spec'd (forward) |
