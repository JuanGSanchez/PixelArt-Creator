...
| REQ-P2-LOGIC-031 | REQ-NEW-C; S2, S5 | `logic/selection.py` (`composite_preview`) | §4.1, §11 | SC-L031-1..4 (SC-L031-1/-2 non-destructive) | `tests/logic/test_floating_selection.py` | done |
| REQ-P2-LOGIC-032 | REQ-NEW-C; S2, S7 | `logic/selection.py` (`commit_floating` MOVE / reuses `move_selection`) | §4.1, §11 | SC-L032-1..5 (SC-L032-2 reversibility, -5 indexed vacate) | `tests/logic/test_floating_selection.py` | done |
| REQ-P2-LOGIC-033 | REQ-NEW-C; S2, S7 | `logic/selection.py` (`copy_selection` builder) | §4.1, §11 | SC-L033-1..4 (SC-L033-2 reversibility, -4 indexed) | `tests/logic/test_floating_selection.py` | done |
| REQ-P2-LOGIC-034 | REQ-NEW-C; S2 | `logic/selection.py` (cancel = no-op) | §4.1, §11 | SC-L034-1 (non-destructive cancel) | `tests/logic/test_floating_selection.py` | done |
| REQ-P2-LOGIC-035 | REQ-NEW-C; S2, S5 | `logic/selection.py` (off-canvas clip) | §4.1, §11 | SC-L035-1..3 (off-canvas clip) | `tests/logic/test_floating_selection.py` | done |
| REQ-P2-LOGIC-036 | REQ-NEW-C; S2; ADR-0008 | `logic/selection.py` (Qt-free purity) | §4.1, §11 | SC-L036-1..2 ; SC-L036-3 (spec-only) | `tests/logic/test_floating_selection.py` + `check_layering`/`check_cycles` | done / spec-only |
