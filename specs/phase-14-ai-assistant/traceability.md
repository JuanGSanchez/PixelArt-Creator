...
| REQ-P14-LOGIC-005 | **SCR-1**, S7, S11, Article I, Article VI (batch), Article II, D1, Researcher `ad2616c7` | §2 (14C), §4, §5 | SC-L005-1, SC-L005-2 | `tests/logic/test_agentic_loop.py` (multi-step scripted run → final message; bounded halt; deterministic under fake) | spec'd (forward) |
