...
| REQ-P3-LOGIC-002 | S3b, **F9** | `logic/color_theory.py` | §4.1, §11 | SC-L002-1..6 (SC-L002-1..4 angle-correctness) | `test_color_theory.py::test_complementary_angle`, `::test_analogous_angles`, `::test_triadic_angles`, `::test_split_complementary_angles`, `::test_hue_wraps_mod_360`, `::test_harmony_dispatch_and_determinism`, `::test_harmony_unknown_scheme_raises`, `::test_complementary_preserves_alpha`, `::test_complementary_hue_wrap_property` | landed |
| REQ-P3-LOGIC-003 | S3b, F9 | `logic/color_theory.py` | §4.1, §11 | SC-L003-1..4 | `test_color_theory.py::test_shade_ramp_length_and_base`, `::test_shade_ramp_value_decreases_monotonically`, `::test_tint_ramp_trends_to_white`, `::test_tone_ramp_desaturates`, `::test_ramps_preserve_alpha`, `::test_ramps_deterministic`, `::test_ramp_rejects_bad_step_count`, `::test_ramp_custom_step_count` | landed |
...
| REQ-P3-LOGIC-005 | S3b; **realises `distance_sq`→perceptual** | `logic/perceptual.py` (+ `logic/palette.py`) | §1, §4.1, §11 | SC-L005-1..4 | `test_perceptual.py::test_nearest_index_perceptual_picks_closest`, `::test_nearest_index_perceptual_ties_to_lower_index`, `::test_nearest_index_perceptual_empty_raises`, `::test_perceptual_can_differ_from_distance_sq`, `::test_ciede2000_matches_sharma_reference_pairs`, `::test_delta_e_2000_default_weights_from_constants` | landed |
...
| REQ-P3-LOGIC-007 | S3b, F9 | `logic/dither.py` | §4.1, §11 | SC-L007-1..3 (SC-L007-1 palette-containment) | `test_dither.py::test_floyd_steinberg_output_subset_of_palette`, `::test_floyd_steinberg_deterministic`, `::test_floyd_steinberg_diffuses_error_to_neighbours`, `::test_floyd_steinberg_requires_rgba`, `::test_floyd_steinberg_empty_palette_raises`, `::test_dither_containment_property` | landed |
...
| REQ-P3-LOGIC-010 | S6, **F9** | `logic/quantize.py` | §4.1, §11 | SC-L010-1..4 (SC-L010-1 ≤N, acceptance-critical) | `test_quantize.py::test_median_cut_at_most_n`, `::test_median_cut_default_n_is_constant`, `::test_median_cut_few_colours_returns_exactly_those`, `::test_median_cut_deterministic`, `::test_median_cut_bad_n_raises`, `::test_median_cut_requires_rgba`, `::test_extraction_at_most_n_property` | landed |
| REQ-P3-LOGIC-011 | S6, **F9** | `logic/quantize.py` | §4.1, §11 | SC-L011-1..3 (SC-L011-1 ≤N, acceptance-critical) | `test_quantize.py::test_kmeans_at_most_n`, `::test_kmeans_deterministic_with_seed`, `::test_kmeans_returns_palette`, `::test_kmeans_few_colours_shortcut`, `::test_kmeans_bad_n_raises`, `::test_kmeans_requires_rgba` | landed |
...
| REQ-P3-LOGIC-014 | S6 | `logic/palette_ops.py` | §4.1, §11 | SC-L014-1..4 (SC-L014-2 reversibility) | `test_palette_ops.py::test_swap_indices_remaps`, `::test_swap_indices_deterministic`, `::test_swap_indices_requires_indexed`, `::test_swap_indices_out_of_range_raises`, `::test_remap_colors_remaps_rgba`, `::test_remap_colors_requires_rgba`, `::test_make_swap_command_reversible`, `::test_make_swap_command_respects_mask`, `::test_swap_reversibility_property` | landed |
